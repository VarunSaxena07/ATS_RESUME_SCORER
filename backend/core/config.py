...
ALLOWED_ORIGINS = [
    'https://atsresumescorer.streamlit.app/'
]  
...
SENTENCE_TRANSFORMER_MODEL = os.getenv(
    ...
    os.getenv("SENRENCE_TRANSFORMER_MODEL", "all-MiniLM-L6-v2"),
)
...
SUPABASE_API_KEY   = os.getenv('SUPABASE_API_KEY', os.getenv('SUPABASE_KEY', ''))
SUPABASE_KEY       = SUPABASE_API_KEY                       # service_role - DB writes (bypasses RLS)
SUPABASE_ANON_KEY  = os.getenv('SUPABASE_ANON_KEY', os.getenv('SUPABSE_ANON_KEY', ''))
